  ...
  <div>
    ...
    >
      <el-collapse v-model="formActiveCollapseNames" class="setting-collapse">
        <el-collapse-item
          name="0"
          :title="i18nt('designer.setting.formConfig')"
        >
          <el-form-item
            label-width="95"
            :label="i18nt('designer.setting.formCategory')"
          >
            <el-tree-select
          ...
          >
            <el-input type="text" v-model="formConfig.formName" :disabled="formConfig.formNameDisabled"></el-input>
          </el-form-item>
          <el-form-item
            label-width="95"
            :label="i18nt('designer.setting.formCode')"
          >
            <el-input type="text" v-model="formConfig.formCode" :disabled="formConfig.formCodeDisabled"></el-input>
          </el-form-item>
        </el-collapse-item>
        <el-collapse-item
          name="1"
