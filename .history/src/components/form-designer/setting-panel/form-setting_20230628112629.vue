  ...
  <div>
    ...
    >
      <el-collapse v-model="formActiveCollapseNames" class="setting-collapse">
        ...
        >
          <el-form-item label-width="95" :label="i18nt('designer.setting.formCategory')">
            <el-input type="text" v-model="formConfig.modelName"></el-input>
          </el-form-item>
          <el-form-item label-width="95" :label="i18nt('designer.setting.formName')">
            <el-input type="text" v-model="formConfig.modelName"></el-input>
          </el-form-item>
          <el-form-item label-width="95" :label="i18nt('designer.setting.formCode')">
            <el-input type="text" v-model="formConfig.modelName"></el-input>
          </el-form-item>
        </el-collapse-item>
        <el-collapse-item
